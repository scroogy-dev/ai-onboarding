...
회사는 보안 정책에 따라 커넥터를 막아 두었을 수 있습니다. 목록에 없으면 **허용 범위 밖**이니 우회할 방법을 찾지 않습니다.
...
#59: 부서 지목·문의 유도 문구 제거, 회사 정책으로 통일. 오른쪽 카드를 docs #enterprise 첫 문단 요약(정책 확인 → 허용된 것만 → 막아 두었을 수 있다 → 목록에 없으면 허용 범위 밖)으로 바꿨다. 「내 탓이 아니라 조직 탓」 식의 문장은 요청하면 열린다는 뜻으로 읽혀 뺐다.
-->
