...
> 본 교육의 hands-on 실습 자료입니다. **로컬에서 따라하기 좋도록** 본문은 GitHub repo 루트의 `labs/` 디렉토리에 있으며, 본 페이지는 인덱스 역할만 합니다.

---

## 진행 원칙

본 시리즈에는 두 가지 진행 원칙이 있습니다.

**① 프롬프트로만 진행합니다.** 본 시리즈는 **프롬프트만으로** 모든 실습을 진행하는 수련을 권장합니다.
...
**② 결과물은 반드시 읽고 이해합니다.** 손으로 쓰지 않더라도, AI가 만든 결과물은 **본인이 직접 읽고 이해한 상태**에서 사용·수정합니다.

- 읽지 않은 결과물은 사용하지 않습니다. [마크다운](basics.md#markdown)·HTML·엑셀·Skill 지시문 모두 마찬가지입니다.
...
- **zip 다운로드**: [main.zip](https://github.com/scroogy-dev/ai-onboarding/archive/refs/heads/main.zip) (압축을 풀면 `labs/` 디렉토리가 나옵니다)

---

## 사전 준비

실습 진행에 필요한 도구·계정은 [홈 페이지 안내](index.md#preparation)를 참고하세요.
