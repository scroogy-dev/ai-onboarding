...
- 일회성 사용을 넘어, **비개발자도 본인 일에 필요한 작은 소프트웨어를 직접 만들 수 있습니다**

> 핵심은 "AI에게 매번 시킨다"가 아니라, **"AI로 나만의 소프트웨어를 만들어 반복 자동화한다"** 는 것입니다.

<div class="grid" markdown>

!!! example "AI 없이 — 사람이 직접"
    회의록 30분치 정리: 직접 1시간 작성 + 검수 30분

    같은 톤의 이메일을 매번 새로 다듬어 작성

!!! success "AI로 — 옆에서 거드는 도구"
    AI가 회의록 초안 정리 → 사람은 검수만, 30분 안쪽

    톤 가이드를 1번 만들어두고 반복 재사용
...
!!! tip "② 소프트웨어로 만들기"
    ...
    **적합**: 반복·일관성·재사용 필요한 작업

    **특성**: 한 번 만들면 **동일한 품질로 반복 보장**

</div>

> 본 교육은 **②번 쪽**에 초점을 맞춥니다 — 비개발자도 자기 일에 필요한 작은 소프트웨어를 만들어 반복 가치를 누리게 하는 것이 목표입니다.
...
이 교육은 긴 이론 강의 대신 **계획 문서를 작성한 뒤 단계별로 실행**하는 방식으로 진행됩니다.
...
!!! info "왜 계획부터 세우나요?"
    ...
    - **시간·비용도 절약됩니다** — AI가 잘못 이해해서 다시 작업하는 비용이 의외로 큽니다.
